  ...
  return (
    <div className="route-container">
      ...
      <style>{`
        ...
        .cms-h2 { font-size: 15px; font-weight: bold; margin: 0 0 14px; color: var(--body-text); }
        .cms-desc { font-size: 13px; color: var(--body-text-muted); margin: 0 0 10px; }
        .cms-section-header { display: flex; align-items: center; gap: 10px; margin-bottom: 12px; }
        .cms-count { font-size: 12px; color: var(--body-text-muted); background: var(--body-border); padding: 2px 7px; border-radius: 10px; font-weight: bold; }
        .cms-msg { padding: 9px 14px; border-radius: 6px; font-size: 13px; margin-bottom: 12px; }
        ...
        /* Badges */
        .cms-badge { font-size: 11px; font-weight: bold; padding: 2px 7px; border-radius: 10px; }
        ...
        .cms-user-header { display: flex; align-items: center; gap: 8px; font-size: 14px; }
        .cms-ban-info { font-size: 12px; color: var(--body-text-muted); display: flex; flex-direction: column; gap: 2px; }
        .cms-field-group { display: grid; gap: 8px; }
        .cms-row { display: flex; align-items: center; gap: 8px; }
        .cms-label { font-size: 12px; font-weight: bold; color: var(--body-text-muted); white-space: nowrap; }
        .cms-select { flex: 1; }
        ...
        .cms-user-group-header { display: flex; align-items: center; justify-content: space-between; padding: 8px 12px; background: var(--body-card-bg); font-size: 13px; font-weight: bold; border-bottom: 1px solid var(--body-border); }
        ...
        .cms-cover-meta { flex: 1; min-width: 0; display: flex; flex-direction: column; gap: 2px; font-size: 13px; overflow: hidden; }
        .cms-cover-meta strong { white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
        .cms-cover-meta span { color: var(--body-text-muted); font-size: 12px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
        ...
        .cms-report-meta { display: flex; flex-direction: column; gap: 4px; font-size: 13px; }
        ...
        .cms-ban-user { font-size: 13px; font-weight: bold; }
        .cms-ban-reason { font-size: 12px; color: var(--body-text-muted); }
        .cms-ban-date { font-size: 11px; color: var(--body-text-muted); }

        /* Operators */
        .cms-op-list { display: grid; gap: 6px; }
        .cms-op-row { display: flex; align-items: center; justify-content: space-between; padding: 8px 12px; border: 1px solid var(--body-border); border-radius: 8px; font-size: 13px; font-weight: bold; }
