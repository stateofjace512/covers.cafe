  ...
  return (
    <div className="cover-page">
      ...
      <style>{`
        ...
        .cover-size-option { padding: 8px 14px; text-align: left; font-size: 16px; font-weight: bold; background: none; border: none; color: var(--body-text); cursor: pointer; box-shadow: none; font-family: var(--font-body); }
        ...
        .cover-page-uploader { display: inline-flex; align-items: center; gap: 5px; background: none; border: none; cursor: pointer; font-size: 16px; color: var(--accent); padding: 0; box-shadow: none; font-family: var(--font-body); font-weight: bold; }
        ...
        .cover-action-sm { display: flex; align-items: center; gap: 5px; font-size: 15px; padding: 6px 12px; background: var(--sidebar-bg); border: 1px solid var(--sidebar-border); color: var(--body-text); }
        ...
        .cover-panel-title { font-size: 18px; font-weight: bold; color: var(--body-text); display: flex; align-items: center; gap: 7px; }
        .cover-panel-muted { font-size: 16px; color: var(--body-text-muted); }
        ...
        .cover-panel-label { font-size: 16px; font-weight: bold; color: var(--body-text); }
        .cover-panel-hint { font-size: 14px; color: var(--body-text-muted); font-weight: normal; }
        .cover-panel-input { flex: 1; min-width: 0; padding: 7px 10px; border-radius: 4px; border: 1px solid var(--body-card-border); background: var(--body-card-bg); color: var(--body-text); font-size: 16px; font-family: var(--font-body); box-shadow: var(--shadow-inset-sm); outline: none; width: 100%; }
        ...
        .cover-panel-status { font-size: 15px; color: var(--body-text-muted); padding: 6px 10px; background: var(--body-border); border-radius: 4px; }
