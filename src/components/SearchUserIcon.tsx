...
export default function SearchUserIcon({ size = 18, className, style }: Props) {
  return (
    <svg
    ...
    >
      ...
      {/* Tiny person inside the lens (interior area ~cols 5-12, rows 5-15) */}
      {/* Head */}
      <path fill="currentColor" d="M10.67 7.62h3.04v3.05h-3.04Z" />
      {/* Body */}
      <path fill="currentColor" d="M9.14 10.67h6.1v4.57H9.14Z" />
      {/* Left leg */}
      <path fill="currentColor" d="M9.14 15.24h1.52v3.05H9.14Z" />
      {/* Right leg */}
      <path fill="currentColor" d="M13.71 15.24h1.52v3.05h-1.52Z" />
    </svg>
  );
}
