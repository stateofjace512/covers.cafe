  ...
  return (
    <div className="notif-wrap">
      ...
      <style>{`
        ...
        .notif-empty { font-size: 16px; color: var(--body-text-muted); padding: 20px 14px; text-align: center; line-height: 1.5; }
        .notif-item {
        ...
        .notif-text { font-size: 15px; color: var(--body-text); line-height: 1.4; margin: 0; }
        .notif-user-link {
          font-weight: bold; color: var(--body-text);
          background: none; border: none; padding: 0; cursor: pointer;
          font-size: 15px; box-shadow: none; font-family: inherit;
        ...
        .notif-comment-preview { font-size: 14px; color: var(--body-text-muted); font-style: italic; margin: 0; line-height: 1.4; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
        .notif-time { font-size: 13px; color: var(--body-text-muted); }
        .notif-dismiss-btn {
