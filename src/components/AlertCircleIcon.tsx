...
export default function AlertCircleIcon({ size = 18, className, style }: Props) {
  return (
    <svg
    ...
    >
      ...
      <path fill="currentColor" d="m18.29 19.81 -4.58 0 0 1.52 -1.52 0 0 4.57 1.52 0 0 1.53 4.58 0 0 -1.53 1.52 0 0 -4.57 -1.52 0 0 -1.52z" />
      <path fill="currentColor" d="m18.29 4.57 -4.58 0 0 1.52 -1.52 0 0 9.15 1.52 0 0 3.05 4.58 0 0 -3.05 1.52 0 0 -9.15 -1.52 0 0 -1.52z" />
