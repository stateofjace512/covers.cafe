  ...
  return (
    <div className="upload-page">
      ...
      <style>{`
        ...
        .upload-mode-hint { font-size: 14px; opacity: 0.75; }
        .upload-requirements {
        ...
        .upload-gate-body { font-size: 17px; color: var(--body-text-muted); line-height: 1.6; }
        .upload-drop-zone {
        ...
        .upload-drop-hint { font-size: 15px; color: var(--body-text-muted); }
        ...
        .autocomplete-hint { font-size: 14px; color: var(--body-text-muted); opacity: 0.9; }
        .form-input:disabled { opacity: 0.5; cursor: not-allowed; }
        .form-hint { font-size: 14px; color: var(--body-text-muted); }
        ...
        .collection-title { font-size: 15px; }
        ...
        .bulk-item-error { width: 100%; display: flex; align-items: center; gap: 5px; font-size: 14px; color: #c83220; margin-top: 2px; }
