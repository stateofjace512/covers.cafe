...
export default function BackIcon({ size = 18, className, style }: Props) {
  return (
    <svg
    ...
    >
      ...
      <path fill="currentColor" d="M28.95 19.81h1.53v3.05h-1.53Z" />
      <path fill="currentColor" d="M28.95 9.14h1.53v3.05h-1.53Z" />
      ...
      <path fill="currentColor" d="M22.86 27.43h3.04v1.52h-3.04Z" />
      <path fill="currentColor" d="m24.38 12.19 -1.52 0 0 -1.52 -9.15 0 0 -3.05 -1.52 0 0 1.52 -1.52 0 0 1.53 -1.53 0 0 1.52 -1.52 0 0 1.52 -1.53 0 0 1.53 1.53 0 0 1.52 1.52 0 0 1.53 1.53 0 0 1.52 1.52 0 0 1.52 1.52 0 0 -3.04 6.1 0 0 1.52 1.52 0 0 1.52 -1.52 0 0 1.53 -1.52 0 0 1.52 3.04 0 0 -1.52 3.05 0 0 -1.53 1.52 0 0 -7.62 -1.52 0 0 -1.52z" />
      <path fill="currentColor" d="M22.86 3.05h3.04v1.52h-3.04Z" />
      <path fill="currentColor" d="M19.81 28.95h3.05v1.53h-3.05Z" />
      <path fill="currentColor" d="M19.81 1.52h3.05v1.53h-3.05Z" />
