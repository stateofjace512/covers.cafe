  ...
  return (
    ...
    >
      ...
      <style>{`
        ...
        .cover-card-year { font-size: 17px; color: var(--body-text-muted); background: var(--body-border); padding: 1px 5px; border-radius: 3px; font-weight: bold; }
        .cover-card-fav-count { display: flex; align-items: center; gap: 2px; font-size: 17px; color: var(--body-text-muted); font-weight: bold; }
        .cover-card-acotw { display: inline-flex; align-items: center; gap: 3px; font-size: 16px; font-weight: bold; color: #b8860b; background: rgba(184,134,11,0.12); border: 1px solid rgba(184,134,11,0.3); padding: 1px 5px; border-radius: 3px; }
        .cover-card-private { display: inline-flex; align-items: center; gap: 3px; font-size: 16px; font-weight: bold; color: #7a6a8a; background: rgba(120,100,140,0.12); border: 1px solid rgba(120,100,140,0.3); padding: 1px 5px; border-radius: 3px; }
